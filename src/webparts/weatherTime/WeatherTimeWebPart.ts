...
import * as strings from 'WeatherTimeWebPartStrings';
import WeatherTime from './components/WeatherTime';
import { IWeatherTimeProps } from './components/IWeatherTimeProps';
...
export default class WeatherTimeWebPart extends BaseClientSideWebPart<IWeatherTimeWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IWeatherTimeProps> = React.createElement(
      WeatherTime,
      {
